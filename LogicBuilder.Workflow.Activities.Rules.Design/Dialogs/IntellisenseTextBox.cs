...
namespace LogicBuilder.Workflow.Activities.Rules.Design
{
    ...
    internal partial class IntellisenseTextBox : TextBox
    {
            ...
            if (list != null && list.Count > 0)
            {
                foreach (object item in list)
                {
                    ...
                    if (item is string)
                    {
                        ...
                        {
                            ImageIndex = (int)MemberIcons.Default
                        };
                    }
                    else if (item is IntellisenseKeyword)
                    {
                        ...
                        {
                            ImageIndex = (int)MemberIcons.Keyword
                        };
                    }
        ...
        private void UpdateIntellisenceDropDown(string text)
        {
            ...
            this.PopulateAutoCompleteList?.Invoke(this, autoCompletionEventArgs);
