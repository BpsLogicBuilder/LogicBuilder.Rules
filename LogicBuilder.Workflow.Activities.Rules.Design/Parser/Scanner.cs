...
namespace LogicBuilder.Workflow.Activities.Rules
{
    ...
    internal class Scanner
    {
        ...
        private static Dictionary<string, KeywordInfo> CreateKeywordMap()
        {
            ...
            {
                { "mod", new KeywordInfo(TokenID.Modulus) },
                { "and", new KeywordInfo(TokenID.And) },
                { "or", new KeywordInfo(TokenID.Or) },
                { "not", new KeywordInfo(TokenID.Not) },
                { "true", new KeywordInfo(TokenID.True, true) },
                { "false", new KeywordInfo(TokenID.False, false) },
                { "null", new KeywordInfo(TokenID.Null, null) },
                { "nothing", new KeywordInfo(TokenID.Null, null) },
                { "this", new KeywordInfo(TokenID.This) },
                { "me", new KeywordInfo(TokenID.This) },
                { "in", new KeywordInfo(TokenID.In) },
                { "out", new KeywordInfo(TokenID.Out) },
                { "ref", new KeywordInfo(TokenID.Ref) },
                { "halt", new KeywordInfo(TokenID.Halt) },
                { "update", new KeywordInfo(TokenID.Update) },
                { "new", new KeywordInfo(TokenID.New) },
                { "char", new KeywordInfo(TokenID.TypeName, typeof(char)) },
                { "byte", new KeywordInfo(TokenID.TypeName, typeof(byte)) },
                { "sbyte", new KeywordInfo(TokenID.TypeName, typeof(sbyte)) },
                { "short", new KeywordInfo(TokenID.TypeName, typeof(short)) },
                { "ushort", new KeywordInfo(TokenID.TypeName, typeof(ushort)) },
                { "int", new KeywordInfo(TokenID.TypeName, typeof(int)) },
                { "uint", new KeywordInfo(TokenID.TypeName, typeof(uint)) },
                { "long", new KeywordInfo(TokenID.TypeName, typeof(long)) },
                { "ulong", new KeywordInfo(TokenID.TypeName, typeof(ulong)) },
                { "float", new KeywordInfo(TokenID.TypeName, typeof(float)) },
                { "double", new KeywordInfo(TokenID.TypeName, typeof(double)) },
                { "decimal", new KeywordInfo(TokenID.TypeName, typeof(decimal)) },
                { "bool", new KeywordInfo(TokenID.TypeName, typeof(bool)) },
                { "string", new KeywordInfo(TokenID.TypeName, typeof(string)) },
                { "object", new KeywordInfo(TokenID.TypeName, typeof(object)) }
            };
            return map;
        }
        ...
        private TokenID ScanStringLiteral()
        {
            ...
            char ch = ScanCharacter(out bool isEscaped);
            for (;;)
            {
                if (ch == '\0' && !isEscaped)
        ...
        private TokenID ScanKeywordOrIdentifier()
        {
            ...
            ScanIdentifier(sb, out bool hasLettersOnly);
            ...
            if (hasLettersOnly && currentToken != TokenID.Dot)
            {
                ...
                if (keywordMap.TryGetValue(strValue.ToLowerInvariant(), out KeywordInfo keyword))
                {
                    token = keyword.Token;
