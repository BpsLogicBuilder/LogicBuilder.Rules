...
namespace LogicBuilder.Workflow.Activities.Rules
{
    ...
    public class RuleMethodInvokeExpressionInfo : RuleExpressionInfo
    {
        ...
        public bool NeedsParamsExpansion
        {
    ...
    public class RuleValidation
    {
        ...
        public RuleValidation(Type thisType)
        {
        ...
        public bool ValidateConditionExpression(CodeExpression expression)
        {
            if (expression == null)
        ...
        public static bool IsValidBooleanResult(Type type)
        {
        ...
        public static bool IsPrivate(FieldInfo fieldInfo)
        {
        ...
        public static bool IsInternal(FieldInfo fieldInfo)
        {
        ...
        public SimpleRunTimeTypeProvider GetTypeProvider()
        {
            return typeProvider;
        }
        ...
        public RuleExpressionInfo ExpressionInfo(CodeExpression expression)
        {
            ...
            expressionInfoMap.TryGetValue(expression, out RuleExpressionInfo exprInfo);
        ...
        public static bool TypesAreAssignable(Type rhsType, Type lhsType, CodeExpression rhsExpression, out ValidationError error)
        {
        ...
        private static bool CheckValueRange(CodeExpression rhsExpression, Type lhsType, out ValidationError error)
        {
            ...
            if (rhsExpression is CodePrimitiveExpression primitive)
            {
                try
                {
        ...
        public MemberInfo ResolveFieldOrProperty(Type targetType, string name)
        {
        ...
        private class Argument
        {
            ...
            internal Argument(CodeExpression expr, RuleValidation validation)
            {
                ...
                if (expr is CodeDirectionExpression directionExpr)
        ...
        public RuleConstructorExpressionInfo ResolveConstructor(Type targetType, BindingFlags constructorBindingFlags, List<CodeExpression> argumentExprs, out ValidationError error)
        {
            string message;
        ...
        public RuleMethodInvokeExpressionInfo ResolveMethod(Type targetType, string methodName, BindingFlags methodBindingFlags, List<CodeExpression> argumentExprs, out ValidationError error)
        {
            string message;
        ...
        private static List<CandidateMember> GetCandidateIndexers(List<PropertyInfo> indexerProperties, List<Argument> arguments, out ValidationError error)
        {
            ...
            {
                EvaluateCandidate(candidates, indexerProp, indexerProp.GetIndexParameters(), arguments, out ValidationError tempError,
        ...
        public void AddTypeReference(CodeTypeReference typeRef, Type type)
        {
        ...
        private Type FindType(string typeName)
        {
            ...
            if (!typesUsed.TryGetValue(typeName, out Type type))
            {
