...
using Sample = SampleFlow;

namespace Console.SampleFlow.Uwp.DefineAndSerialize
{
    internal static class RulesTester
    {
        ...
        private static RuleValidation GetValidation(RuleSet ruleSet, Type type)
        {
            ...
            {
                typeof(Sample.FlowEntity).Assembly,
